...
var _user$project$Main$initialPlayer = {position: 5};
var _user$project$Main$init = function () {
	var initialModel = {player: _user$project$Main$initialPlayer};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		return A2(_user$project$Main$processPlayerMove, _p1._0, model);
	});
var _user$project$Main$playerIsAtIndex = F2(
	function (index, _p2) {
		var _p3 = _p2;
		return _elm_lang$core$Native_Utils.eq(index, _p3.position);
	});
var _user$project$Main$gameBoardView = function (model) {
	var content = function (index) {
		...
		switch (_p4) {
			...
			case 9:
				return _elm_lang$html$Html$text('C');
			default:
				return A2(_user$project$Main$playerIsAtIndex, index, model.player) ? _elm_lang$html$Html$text('P') : _elm_lang$html$Html$text('');
		}
	};
	var makeDiv = function (index) {
		return A2(
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('game-board'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Get The Cheese'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$gameBoardView(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$MoveNone = {ctor: 'MoveNone'};
var _user$project$Main$calculateDirection = function (keycode) {
	var _p5 = keycode;
	switch (_p5) {
		case 38:
			return _user$project$Main$MoveUp;
		case 40:
			return _user$project$Main$MoveDown;
		default:
			return _user$project$Main$MoveNone;
	}
};
var _user$project$Main$PlayerMove = function (a) {
	return {ctor: 'PlayerMove', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$ups(
		function (_p6) {
			return _user$project$Main$PlayerMove(
				_user$project$Main$calculateDirection(_p6));
		});
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"PlayerMove":["Main.MoveDirection"]}},"Main.MoveDirection":{"args":[],"tags":{"MoveUp":[],"MoveDown":[],"MoveNone":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
